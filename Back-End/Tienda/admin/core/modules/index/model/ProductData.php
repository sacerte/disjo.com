...
class ProductData {
	...
	public function add(){
		$sql = "insert into ".self::$tablename." (short_name,code,name,description,image,price,link,category_id,unit_id,is_public,in_existence,is_featured,created_at,stock,price_mayor,price_desc,measurements) ";
		$sql .= "value (\"$this->short_name\",\"$this->code\",\"$this->name\",\"$this->description\",\"$this->image\",\"$this->price\",\"$this->link\",$this->category_id,$this->unit_id,$this->is_public,$this->in_existence,$this->is_featured,$this->created_at,\"$this->stock\",\"$this->price_mayor\",\"$this->price_desc\",\"$this->measurements\")";
		Executor::doit($sql);
	}
