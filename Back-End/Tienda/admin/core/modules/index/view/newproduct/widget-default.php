...
<form class="form-horizontal" role="form" method="post" enctype="multipart/form-data" action="index.php?action=addproduct">
  ...
  <input type="text" class="form-control" placeholder="Precio Pagina" required name="price">
</div>    </div>
  </div>
   ...
   <div class="form-group">
    ...
    <div class="col-lg-10">
      <div class="input-group">
  <span class="input-group-addon"><?php echo $coin; ?></span>
  <input type="text" class="form-control" placeholder="Precio x Mayor" required name="price_mayor">
</div>    </div>
  </div> 
    ...
    <div class="col-lg-10">
      <div class="input-group">
  <span class="input-group-addon"><?php echo $coin; ?></span>
  <input type="text" class="form-control" placeholder="Precio 4%" required name="price_desc">
</div>    </div>
  </div> 
