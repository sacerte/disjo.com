...
<form class="form-horizontal" role="form" enctype="multipart/form-data" method="post" action="index.php?action=updateproduct">
  ...
  <div class="form-group">
    ...
    <div class="col-lg-2">
      <input type="text" class="form-control" name="stock" value="<?php echo $product->stock; ?>" placeholder="stock">
    </div>
	</div>
  
  <div class="form-group">
    <label for="inputEmail1" class="col-lg-2 control-label">Precio Pagina</label>
    <div class="col-lg-10">
      <div class="input-group">
  <span class="input-group-addon"><?php echo $coin; ?></span>
  <input type="text" class="form-control" placeholder="Precio Pagina" value="<?php echo $product->price; ?>" required name="price">
</div>    </div>
  </div>
  
    <div class="form-group">
    <label for="inputEmail1" class="col-lg-2 control-label">Precio x Mayor</label>
    <div class="col-lg-10">
      <div class="input-group">
  <span class="input-group-addon"><?php echo $coin; ?></span>
  <input type="text" class="form-control" placeholder="Precio x Mayor" value="<?php echo $product->price_mayor; ?>" required name="price_mayor">
</div>    </div>
  </div>
  
    <div class="form-group">
    <label for="inputEmail1" class="col-lg-2 control-label">Precio 4%</label>
    <div class="col-lg-10">
      <div class="input-group">
  <span class="input-group-addon"><?php echo $coin; ?></span>
  <input type="text" class="form-control" placeholder="Precio 4 %" value="<?php echo $product->price_desc; ?>" required name="price_desc">
</div>    </div>
  </div>
