    ...
    <div id="wrapper">
      ...
      <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        ...
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="./">Distribuciones JO <sup><small><span class="label label-primary">v1</span></small></sup> </a>
        </div>
...
?>
         <ul class="nav navbar-nav">
		  ...
		  <li><a href="index.php?view=products"><i class="fa fa-glass"></i> Importar Productos</a></li>
