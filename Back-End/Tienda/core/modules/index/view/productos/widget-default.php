...
$img = "http://www.disjo.com/tienda/_lib/file/img/".$p->image;
if($p->image==""){
  $img=$img_default;
}
...
?>
  <div class="col-md-3">
 <center>   <a href="index.php?view=producto&product_id=<?php echo $p->id; ?>"> <img src="<?php echo $img; ?>"  style="width:100px;height:100px;"></center></a>
