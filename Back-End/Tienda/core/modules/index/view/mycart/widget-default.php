	...
	<div class="row">
		...
		<div class="col-md-12">
			<?php if(!isset($_SESSION["client_id"])):?>
				<p class="alert alert-danger">Debes registrarte e iniciar sesion para proceder con la compra.</p>
			<?php endif; ?>
		</div>
</div>
...
<a href="index.php?action=cleancart" class="btn btn-danger btn-block">Limpar Carrito</a>
			...
			?>
				...
				<a title="Los Tejos" href="https://demover3-1.tucompra.net/bt/botonPago.xhtml?boton=Mzc1"><img src="http://www.disjo.com/tienda/_lib/file/img/pse.jpg" width="60" height="60"></a>
				</div>
			<?php endif; ?>
		</div>
	</div>
